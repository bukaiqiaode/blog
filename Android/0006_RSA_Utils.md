# One utility-class to operate RSA
...
public class RSAUtils {
    ...
    /**
     * Use a string to get public-key and then encrypt the provided data.
     * @param data
     * @param publicKey
     * @return
     */
    public static String publicEncrypt(String data, String publicKey){
        try{
            ...
            return Base64.encodeBase64URLSafeString(rsaSplitCodec(cipher, Cipher.ENCRYPT_MODE, data.getBytes(CHARSET), key.getModulus().bitLength()));
        }catch(Exception e){
        	return e.getMessage();
        }
    }
    ...
    /**
     * Use a string to get private-key and then decrypt the provided data.
     * @param data
     * @param publicKey
     * @return
     */
